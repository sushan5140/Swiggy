  ...
  return {
    ...
    messages:[
      ...
      {role:"user",content:JSON.stringify({
        ...
        fees,approval:"Only a proposed basket. Never place an order."
      })}
    ],
  };
}
...
export function evaluateCandidate({intent,catalogue,candidate,fees,quote_time="2026-09-25T10:00:00+05:30"}){
  const contract={
    ...
    snapshot:{address_id:"mock_address_01",observed_at:quote_time,evaluation_at:quote_time,max_age_minutes:5,
      currency:"INR",products:catalogue,fees_inr:fees,valid_discounts_inr:0},
    reference_plan:[],
  ...
  const oracle=auditBasket(intent,catalogue,contract.proposal,fees,quote_time,quote_time);
